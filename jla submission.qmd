...
```
The original data of retail EV penetration was diagnosed for spatial autocorrelation using `r LM_raw$LMerr$method`. The observed value of test statistic of `r LM_raw$LMerr$statistic` at `r LM_raw$LMerr$parameter` degrees of freedom indicates a highly significant relationship.
