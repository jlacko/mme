...
The value of the Moran's I statistic of Retail EV penetration was calculated via package *sfdep*  @parry23, using rook neighborhood definition for determining the adjacency matrix of individual ORPs to evaluate spatial dependency of observed data. 
...
This contribution was supported by the Prague University of Economics and Business project IGS 24/2023.
