...
abstract: 
  "The EU and the Czech Republic aim to reduce transport related CO~2~ emissions compared to 1990 level; a key enabler of this endeavor is expected to be replacement of internal combustion engines by battery operated and hybrid propulsion vehicles. We investigate vehicle registration data in retail segment over the years 2019 to 2022 using stepwise linear regression technique and propose a model explaining rate of adoption of electric vehicles based on 37 socioeconomic predictors observed in 206 Czech administrative areas. Our model finds 5 significant predictors, displays a solid goodness of fit and removes spatial autocorrelation observed in original data."
keywords: 
...
A basic analysis of spatial dependency was performed using package *RCzechia* @lacko23. Spatial autocorrelation of EV penetration at ORP level was measured using Moran's I statistic, as defined in @bivand_pebesma23. 
...
The predictors were calculated as:
